 ...
 * Use the {@link savedRecipesPage#newInstance} factory method to
...
public class savedRecipesPage extends Fragment {
    ...
    public static savedRecipesPage newInstance(String param1, String param2) {
        savedRecipesPage fragment = new savedRecipesPage();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        View.OnClickListener OCLBackSavedHP = v -> Navigation.findNavController(view).navigate(R.id.homePage);
